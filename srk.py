...
def display_header():
    ...
    print(f"{Fore.BLUE}║\033[48;5;4m{' ' * 22}\033[37mA u t h o r :  K u n F z{' ' * 20} \033[0m{Fore.BLUE}║")
    print(f"{Fore.BLUE}║\033[48;5;4m{' ' * 19}\033[37mA d m :  Z' b l a c k  3 1 3{' ' * 19} \033[0m{Fore.BLUE}║")
